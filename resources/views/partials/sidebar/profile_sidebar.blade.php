        ...
        <div id="user_statistics" class="container">
            ...
            <div class="list-group align-items-center mb-5">
                ...
                <div class="d-flex list-group-item w-100">
                    ...
                    <a class="text-decoration-none p-3 text-dark">{{ $statistics['post_num'] }} Posts</a>
                </div>
                ...
                <div class="d-flex list-group-item w-100">
                    ...
                    <a href="/like_list/{{ $user->username }}" class=" text-decoration-none p-3">{{ $statistics['like_comment_num'] + $statistics['like_post_num'] }}
                        Likes</a>
                </div>
                ...
                <div class="d-flex list-group-item w-100">
                    ...
                    <a href="/comment_list/{{ $user->username }}" class="text-decoration-none p-3">{{ $statistics['comment_num'] }} Comments</a>
                </div>
