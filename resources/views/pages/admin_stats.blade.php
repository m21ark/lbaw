    ...
    <div>
        ...
        <div class="list-group align-items-center mb-5">
            ...
            <div class="d-flex list-group-item w-100">
                ...
                <a href="#" class="text-decoration-none p-3">{{ $statistics['posts_c'] }} Posts</a>
            </div>
            ...
            <div class="d-flex list-group-item w-100">
                ...
                <a href="#" class="text-decoration-none p-3">{{ $statistics['users_c'] }} Users</a>
            </div>
            ...
            <div class="d-flex list-group-item w-100">
                ...
                <a href="#" class="text-decoration-none p-3">{{ $statistics['reports_c'] }} Reports</a>
            </div>
            ...
            <div class="d-flex list-group-item w-100">
                ...
                <a href="#" class="text-decoration-none p-3">{{ $statistics['groups_c'] }} Groups</a>
            </div>
            ...
            <div class="d-flex list-group-item w-100">
                ...
                <a href="#" class="text-decoration-none p-3">{{ $statistics['likes_c'] }}
                    Likes</a>
            </div>
            ...
            <div class="d-flex list-group-item w-100">
                ...
                <a href="#" class="text-decoration-none p-3">{{ $statistics['comments_c'] }} Comments</a>
            </div>
